...
while True:
    ...
    #Next 2 lines help us to detect where are the all faces in the video
    ...
    for i in range(0, detections.shape[2]): #Loop over detections
        ...
        if probability > 0.5: #No need to check weak probabilities
            ...
            #face = np.expand_dims(face, axis=0) #Check line 51
    ...
    if len(facelist) > 0:
        facelist = np.array(facelist) #If you want to read just one face, delete this line and use line 44th
